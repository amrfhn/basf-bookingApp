...
export default {
  ...
  */
   ...
   */
  router: {
    base: process.env.ROUTER_BASE || '/future_of_work/',
    middleware: 'auth'
  },
  ...
  */
  head: {
    ...
    link: [
      { rel: 'stylesheet', type: 'text/css', href: (process.env.RESOURCE_URL || '/future_of_work/mobile/') + 'style/bootstrap.min.css' },
      { rel: 'stylesheet', type: 'text/css', href: (process.env.RESOURCE_URL || '/future_of_work/mobile/') + 'style/font-awesome.min.css' },
      { rel: 'stylesheet', type: 'text/css', href: (process.env.RESOURCE_URL || '/future_of_work/mobile/') + 'style/green.semantic.min.css' }
    ],
    script: [
      { src: (process.env.RESOURCE_URL || '/future_of_work/mobile/') + 'js/jquery.min.js', defer: true },
      { src: (process.env.RESOURCE_URL || '/future_of_work/mobile/') + 'js/bootstrap_3.min.js', defer: true },
      { src: (process.env.RESOURCE_URL || '/future_of_work/mobile/') + 'js/semantic.min.js', defer: true }
    ]
  },
  ...
  */
  ...
  env: {
    ...
    BACKEND_URL: process.env.BACKEND_URL || '/future_of_work/mobile/'
  },
  ...
  */
  axios: {
    retry: { retries: 3 },
    baseURL: (process.env.BACKEND_URL || '/future_of_work/mobile/') + 'api/'
  },
